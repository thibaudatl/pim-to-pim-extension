    ...
    <div>
      ...
      >
        ...
        {[
          ...
          {
            key: 'checkDependencies' as const,
            label: 'Check destination dependencies',
            description:
              'Detect missing families, attributes, categories, etc. in the target and offer to auto-create them before sync.',
          },
